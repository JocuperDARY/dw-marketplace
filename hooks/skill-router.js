...
const INTENT_ROUTES = [
  ...
  { id:'wrapup',skill:'development-workflow-skill:dw-wrapup',name:'收尾与知识持久化',
    groups:[['收尾','提交','commit','push','知识','文档','基线','对比','finalize','wrap up','merge','baseline','memory','持久化','同步']]},
  { id:'optimization',skill:'development-workflow-skill:dw-optimization',name:'优化方法论',
  ...
  { id:'debugging',skill:'development-workflow-skill:dw-debugging',name:'深度调试',
...
const TASK_TYPE_ROUTES = [
  { id:'implement', skill:'development-workflow-skill:dw-planning', fallback:'development-workflow-skill:dw-implementation', name:'实现/创建',
  ...
  { id:'debug', skill:'development-workflow-skill:dw-diagnosis', fallback:'development-workflow-skill:dw-debugging', name:'调试/修复',
  ...
  { id:'optimize', skill:'development-workflow-skill:dw-optimization', fallback:null, name:'优化/重构',
  ...
  { id:'review', skill:'development-workflow-skill:dw-verification', fallback:'development-workflow-skill:dw-reference', name:'审查/检查',
  ...
  { id:'explore', skill:'development-workflow-skill:dw-tooling', fallback:null, name:'理解/探索',
  ...
  { id:'deploy', skill:'development-workflow-skill:dw-wrapup', fallback:null, name:'部署/运维',
