...
const HOOK_STATUS=[
{name:'tool-inventory.js',trigger:'SessionStart',desc:'扫描并缓存可用工具/skills/MCP',icon:'🟢'},
...
{name:'session-start.js',trigger:'SessionStart',desc:'项目上下文 + 工具协议 + memory',icon:'🟢'},
{name:'tool-routing.js',trigger:'PreToolUse(code edits)',desc:'铁律A1/B1/B4 代码变更前检查',icon:'🟢'},
{name:'subagent-context.js',trigger:'PreToolUse(Bash/Task)',desc:'子代理上下文注入 (spec/PRD/plan)',icon:'🟢'},
